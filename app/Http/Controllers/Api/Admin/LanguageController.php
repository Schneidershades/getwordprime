...
class LanguageController extends Controller
{
     ...
     * @OA\Post(
     *      path="/api/v1/admin/languages",
     *      operationId="postAdminLanguages",
     *      tags={"Admin"},
     ...
     *      operationId="showAdminLanguages",
     *      tags={"Admin"},
     ...
     * @OA\Put(
     *      path="/api/v1/admin/languages/{id}",
     *      operationId="adminAdminLanguages",
     *      tags={"Admin"},
     ...
     * @OA\Delete(
     *      path="/api/v1/admin/languages/{id}",
     *      operationId="deleteAdminLanguages",
     *      tags={"Admin"},
