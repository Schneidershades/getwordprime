...
class ExportController extends Controller
{
     ...
     *      operationId="exportAllScriptResponses",
     *      tags={"Shared"},
     *      summary="exportAllScriptResponses",
     *      description="exportAllScriptResponses",
     *      @OA\Parameter(
     *          name="id",
     ...
     *      operationId="exportAllFavoriteScripts",
     *      tags={"Shared"},
     *      summary="exportAllFavoriteScripts",
     *      description="exportAllFavoriteScripts",
     *      @OA\Parameter(
     *          name="id",
     *          description="The defined user id",
     *          required=false,
     ...
     *      operationId="exportAllCampaignScriptResponses",
     *      tags={"Shared"},
     *      summary="exportAllCampaignScriptResponses",
     *      description="exportAllCampaignScriptResponses",
     *      @OA\Parameter(
     *          name="id",
